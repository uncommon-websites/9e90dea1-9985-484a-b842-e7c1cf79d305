...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Kyle Liebler",
		role: "Founder",
		image: "/generated/image-a-group-of-four-friends-diverse-in-gende.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I spent years watching my digital identity be defined by a username I settled for because my actual name was taken everywhere. That disconnect between who I am and how people found me online became the invisible ceiling on my personal brand."`}
			/>
